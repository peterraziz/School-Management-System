...
class ReceiptStudentsRepository implements ReceiptStudentsRepositoryInterface{
    ...
    public function store($request)
    {
        ...
        try {
            ...
            // Save data in ReceiptStudent table
            ...
            // Save data in FundAccount table
            $fund_accounts = new FundAccount();
            $fund_accounts->date = date('Y-m-d');
            $fund_accounts->receipt_id = $receipt_students->id; // after saving the table above, get the id
            ...
            // Save data in Student_Account table
...
// // To get the data when clicked on the button
    ...
    public function update($request)
    {
        ...
        try {
            ...
            // Edit data in ReceiptStudent table
