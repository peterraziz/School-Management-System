        ...
        <nav class="admin-header navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row side-menu-bg" 
            ...
            <ul class="nav navbar-nav mr-auto">
                <li class="nav-item">
                    <a id="button-toggle" class="button-toggle-nav inline-block ml-20 pull-left"
                        href="javascript:void(0);"><i class="zmdi zmdi-menu ti-align-right" style="color: rgb(0, 0, 0);"></i>
                    </a>
                </li> 
            </ul> 
            ...
            <ul class="nav navbar-nav ml-auto">
                ...
                <div class="btn-group mb-1">
                    <button type="button" class="dropdown-toggle" style="background-color: rgba(164, 164, 164, 0.781); padding: 10px 20px; border-radius: 8px; text-align: center; display: inline-block;" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <li class="nav-item fullscreen">
                    <a id="btnFullscreen" href="#" class="nav-link">
                        <i class="ti-fullscreen" style="color: rgb(0, 0, 0);"></i>
                    </a>
                </li> 
                ...
                <li class="nav-item dropdown mr-30"> 
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <a class="dropdown-item" href="{{route('admin_profile.index')}}"><i class="text-warning ti-user"></i>{{ trans('subjects_trans.profile') }}</a> 
