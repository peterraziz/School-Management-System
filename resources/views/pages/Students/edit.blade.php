                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input required value="{{$Students->getTranslation('name','ar')}}" type="text" name="name_ar"  class="form-control">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input required value="{{$Students->getTranslation('name','en')}}" class="form-control" name="name_en" type="text" >
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input required type="email" value="{{ $Students->email }}" name="email" class="form-control" >
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input required type="text" value="{{ $Students->National_ID }}" name="National_ID" class="form-control" >
                                </div> 
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input required type="text" value="{{ $Students->Phone_number }}" name="Phone_number" class="form-control" >
                                </div> 
                            </div>
                            ...
                            {{-- <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input required value="{{ $Students->password }}" type="password" name="Password" class="form-control" >
                                </div>
                            </div> --}} 
                            <div class="col">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <span title="{{ trans('subjects_trans.show_pass') }}" class="input-group-text" onclick="togglePassword3()" style="cursor: pointer;">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="custom-select mr-sm-2" name="gender_id">
                                        <option required selected disabled>{{trans('Parent_trans.Choose')}}...</option>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input required class="form-control" type="text" value="{{$Students->Date_Birth}}" id="datepicker-action" name="Date_Birth" data-date-format="yyyy-mm-dd">
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select required class="custom-select mr-sm-2" name="parent_id">
                                        ...
                                        @foreach($parents as $parent)
                                            <option value="{{ $parent->id }}" {{ $parent->id == $Students->parent_id ? 'selected' : ""}}>{{ $parent->Name_Father }} - {{ $parent->Name_Mother }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
...
<script>
    function togglePassword3() {
        var passwordInput = document.getElementById("password3"); // Updated to match your input ID
