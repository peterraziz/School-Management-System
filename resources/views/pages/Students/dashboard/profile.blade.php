                ...
                <div class="col-lg-4">
                    <div class="card mb-4">
                        <div class="card-body text-center">
                            ...
                            <p class="text-muted mb-1">{{ trans('subjects_trans.student') }}</p><hr>
                            <p class="text-muted mb-1">{{$information->grade->Name}} - 
                                                        {{$information->classroom->Name_Class}} - 
                                                        {{$information->section->Name_Section}}
                            </p>
                        </div>
                    </div>
                </div>
