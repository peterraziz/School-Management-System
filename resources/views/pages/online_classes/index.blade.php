                                    ...
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        @foreach($online_classes as $online_classe)
                                            <tr>
                                                ...
                                                <td> 
                                                    <a href="{{ route('indirect.edit', $online_classe->id) }}" class="btn btn-info btn-sm" 
                                                        title="{{ trans('subjects_trans.edit') }}" role="button" aria-pressed="true">
                                                        <i class="fa fa-edit"></i>
                                                    </a> 
                                                    
                                                    <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" 
                                                    title="{{ trans('subjects_trans.delete') }}" data-target="#Delete_receipt{{$online_classe->meeting_id}}"> <i class="fa fa-trash"></i>
                                                    </button>  
