            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    <div class="col-xl-12 mb-30">
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                <a href="{{route('QuizzesTeacher.create')}}" class="btn btn-success btn-sm" role="button"
                                        ...
                                        @foreach($quizzes as $quizze)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{route('QuizzesTeacher.show',$quizze->id)}}" class="btn btn-warning btn-sm" role="button" aria-pressed="true" 
                                                        title="{{trans('subjects_trans.Show_questions')}}"> <i class="fa fa-binoculars"></i>
                                                    </a>
                                                
                                                    <a href="{{route('student_quiz',$quizze->id)}}" class="btn btn-success btn-sm" role="button" aria-pressed="true" 
                                                        title="{{trans('subjects_trans.list_tested')}}"> <i class="far fa-eye"></i>
                                                    </a>
                                                
                                                
                                                    <a href="{{route('QuizzesTeacher.edit',$quizze->id)}}" class="btn btn-info btn-sm" role="button" aria-pressed="true" 
                                            ...
                                            <div class="modal fade" id="delete_exam{{$quizze->id}}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <form action="{{route('QuizzesTeacher.destroy','test')}}" method="post">
                                                        {{method_field('delete')}}
                                                        {{csrf_field()}}
