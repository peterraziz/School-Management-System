                                ...
                                <div class="table-responsive">
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        @foreach($Teachers as $Teacher)
                                            ...
                                            <td>{{$Teacher->specializations->Name}}</td> {{--specializations Model Function to get the specialization Name --}}
                                                <td>
                                                    <a href="{{route('Teachers.edit',$Teacher->id)}}" class="btn btn-info btn-sm" role="button" aria-pressed="true" title="{{trans('subjects_trans.edit')}}"><i class="fa fa-edit"></i></a>
                                            ...
                                            <div class="modal fade" id="delete_Teacher{{$Teacher->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    ...
                                                    <br>
                                                        <input id="Name" type="text" name="Name"
                                                        class="form-control"
                                                        value="{{ $Teacher->specializations->Name }}" disabled>
