    ...
    <div class="card card-statistics h-100">
        <div class="card-body">
            ...
            <button type="button" class="button x-small" data-toggle="modal" data-target="#exampleModal">
                ...
                <button type="button" class="button x-small btn-danger" id="btn_delete_all">
                ...
                <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50"
                    ...
                    <thead>
                        <tr class="alert-success">
                            <th><input name="select_all" id="example-select-all" type="checkbox" onclick="CheckAll('box1', this)" />  {{ trans('My_Classes_trans.select') }}  </th>
                            <th>#</th>
                    ...
                    <tbody>
                    {{-- This code for Filter_Classes Method --}}
                    @if (isset($details))
                                            ...
                                            <form action="{{ route('Classrooms.update', 'test') }}" method="post">
                                                ...
                                                <div class="form-group">
                                                    <label
                                                        ...
                                                        :</label>
                                                    <select class="custom-select" id="exampleFormControlSelect1" name="Grade_id">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('Classrooms.destroy', 'test') }}" method="post">
                                                ...
                                                <input id="Name" type="text" name="Name"
                                                    class="form-control"
                                                    {{-- value="{{ $My_Class->getTranslation('Name_Class', 'ar') }} - {{ $My_Class->getTranslation('Name_Class', 'en') }}" disabled> --}}
                                                    value="{{ $My_Class->Name_Class }}" disabled>
                                                <br>
                                                ...
                                                {{-- <div class="form-group">
                                                    ...
                                                    <input id="Name" type="text" name="Name"
                                                    class="form-control"
                                                    value="{{ $My_Class->Grades->Name }}" disabled>
