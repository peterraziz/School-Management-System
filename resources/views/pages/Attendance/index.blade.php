                                    ...
                                    @foreach ($students as $student)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                {{-- this code is with store the other way in Repository\AttendanceRepository.php --}}
                                                ...
                                                {{-- @if(isset($student->attendance()->where('attendence_date',date('Y-m-d'))->first()->student_id))
                                                    ...
                                                    <label class="block text-gray-500 font-semibold sm:border-r sm:pr-4">
                                                        <input name="attendences[{{ $student->id }}]" disabled
                                                            {{ $student->attendance()->first()->attendence_status == true ? 'checked' : '' }}
                                                    ...
                                                    <label class="ml-4 block text-gray-500 font-semibold">
                                                        <input name="attendences[{{ $student->id }}]" disabled
                                                            {{ $student->attendance()->first()->attendence_status == false ? 'checked' : '' }}
                                                            class="leading-tight" type="radio" value="absent">
                                                        <span class="text-danger">{{trans('attendance_trans.absence')}}</span>
                                                    </label>
                                                    ...
                                                    data-toggle="modal"  
                                                    data-target="#edit_attendance2{{ $student->id }}" 
                                                    title="{{trans('subjects_trans.edit')}}">
                                                    <i class="fa fa-edit"></i> 
                                                    </button> 
                                                    @include('pages.Attendance.edit_attendance2') {{--Modal
